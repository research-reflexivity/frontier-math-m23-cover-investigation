...
\title[An $M_{23}$ Hurwitz scheme]
  {An $M_{23}$ Hurwitz scheme:\\
...
\hypersetup{
  pdftitle={An M23 Hurwitz scheme: exact arithmetic and reduction at 23},
...
cross-products, and critical algebra.  At this revision that new
Magma check is prepared but unrun; it is not covered by the older
Magma records.  Neither generating its input nor verifying its
checksum is counted as a successful Magma execution.
...
in \cref{sec:certificates}.  The new generic-model Magma check remains
unrun; the older tail function-field records are identified separately.
